		if dice == 1:
			...
			desc = 	f'and you find a underground lake. You are uncertain to swim these waters.'
		elif dice == 93:
			...
			desc = 	f'but you find a spiked net above you that got triggered by yourself! Make a DC13 **DEX SAVE** to not get hurt or type `!hp -d4 [Piercing]`'
		elif dice == 95:
